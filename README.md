<div align="center">
  <img src="https://placehold.co/800x200/0f172a/ecfeff?text=Cloud+Security+Architect+|+Threat+Mitigation+Specialist" alt="Banner" width="100%"/>
...
**Cloud Security Specialist** with associate degree in Cybersecurity and industry certifications. Focused on designing secure AWS architectures while developing hands-on expertise in threat detection and vulnerability management through practical lab environments. Currently advancing skills in cloud-native security frameworks and security automation.
...
**🛡️ Cloud Security**  
> AWS IAM • GuardDuty • Security Hub • KMS • WAF • CloudTrail • Inspector • Config Rules  
> Secure Architecture Design • Cloud Hardening • Compliance Frameworks

**🔍 Threat Analysis**  
> SIEM Solutions (Splunk, QRadar) • Vulnerability Scanning • Log Analysis • Incident Response  
> MITRE ATT&CK Framework • Threat Hunting • Security Automation

**⚙️ Infrastructure & Tools**  
> Terraform • AWS CloudFormation • Docker Security • Python (Boto3) • Bash/PowerShell  
> Git • Jupyter Notebooks • Security Orchestration
